#!/usr/bin/env python3
"""
ASHD Monitoring Agent for Rhel (Non-Root Version)
"""
    ...
    def get_system_metrics(self):
        ...
        try:
            ...
            service_status = {
                ...
                'chronyd': self._check_service('chronyd') if 'rhel' in ['rhel', 'centos', 'rocky'] else self._check_service('ntp'),
