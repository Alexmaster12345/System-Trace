#!/usr/bin/env python3
"""
ASHD Monitoring Agent for Debian (Non-Root Version)
"""
...
class NonRootASHDAgent:
    ...
    def get_system_metrics(self):
        ...
        try:
            ...
            service_status = {
                ...
                'chronyd': self._check_service('chronyd') if 'debian' in ['rhel', 'centos', 'rocky'] else self._check_service('ntp'),
    ...
    def _get_ntp_status(self):
        ...
        try:
            if 'debian' in ['rhel', 'centos', 'rocky']:
                # Use chronyc
