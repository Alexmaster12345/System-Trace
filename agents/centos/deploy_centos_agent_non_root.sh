#!/bin/bash
# System Trace Agent Deployment Script for Centos (Non-Root Version)
...
echo "🚀 Deploying System Trace Agent for Centos (Non-Root)"
echo "=================================================="
...
if [ "centos" = "ubuntu" ] || [ "centos" = "debian" ]; then
    # Ubuntu/Debian NTP
