...
# Deploy System Trace Agent to 192.168.50.89 (Unknown)
# ================================================

# Step 1: Copy agent files to host
echo "📁 Copying agent files to 192.168.50.89..."
scp agents/unknown/system-trace_agent.py root@192.168.50.89:/opt/system-trace-agent/
scp agents/unknown/deploy_unknown_agent.sh root@192.168.50.89:/tmp/
scp agents/unknown/system-trace-agent.service root@192.168.50.89:/tmp/
...
ssh root@192.168.50.89 'systemctl status system-trace-agent | head -5'
